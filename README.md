...
Technical professional with 10+ years of experience in IPTV and Digital Signage systems, working on deployments across Europe.

My background combines system integration, streaming technologies, and content delivery platforms, with hands-on experience in Linux-based environments, CMS, and media players (Chromium-based and BrightSign).
...
### IPTV Portal
Personal project aimed at building a real-world IPTV solution from scratch, based on my professional experience in IPTV systems.

Focused on understanding the full content workflow, from management and UI to delivery and playback, while experimenting with modern web technologies.

👉 https://github.com/AxelSan79/IPTV_Portal

---

### UOC – Multimedia Degree Projects
Collection of academic projects related to multimedia development, web technologies, and content creation.

👉 https://github.com/AxelSan79/UOC
...
- Streaming technologies & content delivery  
...
- Multimedia content design and user experience  
